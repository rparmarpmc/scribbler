...
const ImageZoomOutIcon = ({ width, height, color }) => {
    return (
        <svg className='icon image-zoom-out-icon' xmlns='http://www.w3.org/2000/svg' width={width} height={height} viewBox='0 0 32 32'>
            <path
            ...
            />
            <path
                d='M9.8,15.1c2.8-0.1,5.6-0.2,8.5-0.3c0.9,0,1.8-0.8,1.8-1.8c0-0.9-0.8-1.8-1.8-1.8c-2.8,0.1-5.6,0.2-8.5,0.3
			    c-0.9,0-1.8,0.8-1.8,1.8C8,14.2,8.7,15.1,9.8,15.1L9.8,15.1z'
                fill={color}
            />
        </svg>
    )
...
export default ImageZoomOutIcon

ImageZoomOutIcon.propTypes = {
