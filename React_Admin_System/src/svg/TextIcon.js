...
const TextIcon = ({ width, height }) => {
    return (
        <svg version='1.1' id='Layer_1' width={width} height={height} viewBox='0 0 31.5 31.5' xmlns='http://www.w3.org/2000/svg'>
            <g id='g832' transform='matrix(0.75872523,0,0,0.75872523,-2.8445426,3.6299494)'>
                <path
                    ...
                    id='path824'
                />
                <path d='m 9.4,21.6 c 3.7,-0.3 7.4,-0.6 11,-0.8 0.9,-0.1 1.8,-0.8 1.8,-1.8 0,-0.9 -0.8,-1.9 -1.8,-1.8 -3.7,0.3 -7.4,0.6 -11,0.8 -0.9,0.1 -1.8,0.8 -1.8,1.8 0.1,0.9 0.8,1.9 1.8,1.8 z' id='path828' />
            </g>
            <g id='g842' transform='matrix(0.74570038,0,0,0.74570038,13.181709,5.7352914)'>
                <path
                    ...
                    id='path834'
                />
                <path d='m 11.3,22.1 c 2.4,-0.1 4.9,-0.2 7.3,-0.3 0.9,0 1.8,-0.8 1.8,-1.8 0,-0.9 -0.8,-1.8 -1.8,-1.8 -2.4,0.1 -4.9,0.2 -7.3,0.3 -0.9,0 -1.8,0.8 -1.8,1.8 0.1,1 0.8,1.9 1.8,1.8 z' id='path838' />
            </g>
        </svg>
    )
}
