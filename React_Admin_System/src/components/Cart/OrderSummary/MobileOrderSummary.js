...
const MobileOrderSummary = ({
    ...
    return (
        <div className="cart-mobile-order-summary-wrapper">
            <div className="cart-order-summary-errors mobile-cart-errors">
            ...
            {drawerOpenned && (
                <>
                    <div className="cart-order-summary-title">
                        Order Summary
                    </div>
            ...
            <button
                className={`cart-order-mobile-summary-checkout ${
            ...
            <button
                className="cart-order-mobile-summary-shopping"
...
MobileOrderSummary.propTypes = {
    drawerOpenned: PropTypes.bool.isRequired,
